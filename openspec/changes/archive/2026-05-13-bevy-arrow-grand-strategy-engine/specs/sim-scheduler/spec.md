...
### (Compatibility) Requirement: Tick-Boundary Command Consumption (↔ bevy-bridge, ↔ journal-system)
...
### (Compatibility) Requirement: Atomic Commit Trigger (↔ journal-system, ↔ arrow-store)
...
#### Snapshot Refresh Signal Protocol (DC-10)
...
6. Rule-IR evaluator clears prefetch cache (DC-7)
...
### (Compatibility) Requirement: System Registration with Dependency Graph
...
- Build the REFRESH_SIGNAL recipient list (see DC-10 above)

### (Compatibility) Requirement: Scheduler Initialization Validation
