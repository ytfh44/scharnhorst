...
### (Compatibility) Requirement: Checkpoint & Journal Truncation (↔ arrow-store, ↔ journal-system)
...
### (Compatibility) Requirement: Mod-Aware Load Tolerance (↔ content-loader, ↔ schema-registry)
...
### (Compatibility) Requirement: Rollback & Historical Snapshots (↔ journal-system)
...
### (Compatibility) Requirement: Multiplayer Save Architecture (↔ bevy-bridge, ↔ sim-scheduler)
