...
Content compilation and mod overlay merging SHALL complete **before** the `sim-scheduler` starts the first tick. The loader operates as part of the six-phase load lifecycle (see `save-system`).
